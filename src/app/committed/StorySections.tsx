...
// Background comes from the alternating .surface-a / .surface-b classes on each
// section (see globals.css), so the page reads as distinct bands.
...
export default function StorySections() {
  return (
    <>
      {/* ── How it works ─────────────────────────────────────────── */}
      <section id="how-it-works" className="surface-a" style={sectionStyle}>
      ...
      <section id="results" className="surface-b" style={sectionStyle}>
        <div style={innerStyle}>
      ...
      {/* ── Sample outputs ───────────────────────────────────────── */}
      <section id="sample-outputs" className="surface-a" style={sectionStyle}>
        <div style={innerStyle}>
...
+    => AsyncHelpers.RunSync(() => ExecuteAsync(request, cancellationToken));`,
      ...
      {/* ── Run it locally ───────────────────────────────────────── */}
      <section id="run-locally" className="surface-b" style={sectionStyle}>
        <div style={innerStyle}>
...
git diff | committed`}
      ...
      {/* ── Built with & links ───────────────────────────────────── */}
      <section id="built-with" className="surface-a" style={sectionStyle}>
        <div style={innerStyle}>
