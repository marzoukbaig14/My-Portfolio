...
export const profile: Profile = {
  ...
  about: [
    "I'm Marzouk. First-year MS AI student at Northeastern, came in with a CS undergrad from Rochester and a few years across software engineering, data science, and ML.",
    "Two things have most of my attention right now. At the Roux Institute at Northeastern I do applied ML research, currently scoping an entity-resolution problem on large-scale operational data for an industry-sponsored project with a multinational corporation. The other is LineGuard, which I co-founded: a low-cost computer-vision system that makes automated in/out line calls for padel, running in real time on a Jetson at the edge of the court. I spend most of my time there on the modeling and training.",
  ...
  socials: {
    ...
    linkedin: "https://linkedin.com/in/muhammadmarzoukbaig",
    email: "baig.muham@northeastern.edu"
  },
  resume: "/resume.pdf"
};